namespace API.SignalR
{
    ...
    public class PresenceHub(OnlinePresenceManager _presenceTracker) : Hub
    {
        ...
        {
            var isFirstConnection = await _presenceTracker.UserConnected(Context.User.GetPublicId().Value, Context.ConnectionId);
        ...
        {
            var isJustDisconnected = await _presenceTracker.UserDisconnected(Context.User.GetPublicId().Value, Context.ConnectionId);
